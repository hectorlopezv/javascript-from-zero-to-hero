...
class UI {
   ...
   imprimirCitas() { // Se puede aplicar destructuring desde la función...
        ...
        //this.textoHeading(citas);
        //leer el contenido de dla base de datos
        const objectStore = DB.transaction('citas').objectStore('citas');
        //haciendo validacion si esta vacio o ono
...
function crearDB()
{
    ...
    crearDB.onerror = function() {console.log('Hubo problemas')};
    crearDB.onsuccess = function() 
    {
        DB = crearDB.result;
        console.log('Exitoso compañero')
        ui.imprimirCitas();//cargas citas de la databas indexDB
    };
    crearDB.onupgradeneeded = function(e) 
    {// Hacemos una vez se ha creado la Base de datos
        //creamos las columnas
        const db = e.target.result;

        //creamos el objeto JSON entiendo que es como una TABLA
        const objectStorage = db.createObjectStore('citas',
        {
            //keypath es como el primary key con el que se va identificar
            //cada OBJECTO
