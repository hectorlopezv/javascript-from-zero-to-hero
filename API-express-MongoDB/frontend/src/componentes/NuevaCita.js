...
const NuevaCita = (props) => {
    ...
    // lea los datos del formulario antes de mandar el fomrulario
    ...
    //validar Formulario y mandar peticion con AXIOS
    const crearNuevaCita = (e) => {
        e.preventDefault();
        //antes hacer validacion de Formulario
    ...
    return (  
        <Fragment>
        <h1 className="my-5">nueva Cita de Pacientes</h1>
